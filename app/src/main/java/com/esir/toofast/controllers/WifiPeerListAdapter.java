...
public class WifiPeerListAdapter extends BaseAdapter {
    ...
    private final List<WifiP2pDevice> mData = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_peer_device, null);
    ...
    private static class ViewHolder {
        ...
        ViewHolder(View root) {
            mName = root.findViewById(R.id.textview_single_peer);
        }
    }
}